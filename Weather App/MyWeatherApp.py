...
def main():
    ...
    def optionmenu_callback(choice):
        user = choice
        # api_key_1 = "14e0dc54cd77636ca09d7c8f230766a0"
        api_key = "17e09ffa5a288ef3c3328cfafa1719dc"


        #The URL is constructed using string formatting to include these variables in the correct format.

        # url = f"https://api.openweathermap.org/data/2.5/weather?q={user}&appid={api_key_1}"
